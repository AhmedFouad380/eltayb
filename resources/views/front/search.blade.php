                ...
                <div class="container">
                    <div class="archive-header">
                        <div class="row align-items-center">
                            <div class="col-xl-3">
                                <h1 class="mb-15">  @if(Request::segment(1) == 'Hot-Deals') {{__('lang.Hot Deals')}}  @else {{__('lang.search')}} @endif
                                </h1>
                                <div class="breadcrumb">
                                    <a href="{{url('/')}}" rel="nofollow"><i class="fi-rs-home mr-5"></i>{{__('lang.Home')}}</a>
                                    <span></span>   @if(Request::segment(1) == 'Hot-Deals') {{__('lang.Hot Deals')}}  @else {{__('lang.search')}} @endif
